...
HD_PWD='D:/UCT 2023/EEE4120F High Performance Embedded Systems/YODA/ReadImage/YODA_module_read/YODA_module_read.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log read_Testbench.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source read_Testbench.tcl
