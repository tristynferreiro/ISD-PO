...
HD_PWD='D:/UCT 2023/EEE4120F High Performance Embedded Systems/YODA/ReadImage/YODA_module_read/YODA_module_read.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log read_Testbench.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source read_Testbench.tcl -notrace
