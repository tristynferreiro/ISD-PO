...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/sarah/Documents/1. UNIVERSITY/University/EEE4120F/ISD-PO/Software/VHDL/Application 1 - leave alone/YODA_module_read - BRAM working/YODA_module_read.cache/compile_simlib/modelsim"
  fi
